...
# Local delta vs plugins/dev-core/tools/license_check.py — do not flatten on vendor sync.
# Keeps compound SPDX splitting, Apache-2.0 WITH LLVM-exception (llvmlite), PSF-2.0,
# and the UNKNOWN bucket. --self-test is grafted from canonical; policy logic is not.
